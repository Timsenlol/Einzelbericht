...
\documentclass[
    ...
    oneside,          % GEÄNDERT: von twoside auf oneside
    openany,          % GEÄNDERT: von openright auf openany
    titlepage,
    parskip=half,
    headings=normal,
    listof=totoc,
...
\newcommand{\titel}{Einzelprojektbericht zum Projekt SecHub}
\newcommand{\autor}{Georg Simon Ohm}
\newcommand{\matrikelnr}{3804283}
...
\include{content/2_Vison_Thmenfindung}
\include{content/3_Projektorga}
\include{content/4_Projektvorgehen}
\include{content/5_TechStack}
\include{content/6_Architektur}
\include{content/7_Sprints}
